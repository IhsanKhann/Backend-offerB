// pages/ExpenseTransactions/PaidExpenses.jsx
  ...
  return (
    <div className="flex bg-gray-100 min-h-screen">
      ...
      <main className="flex-1 p-6">
        <h1 className="text-3xl font-bold mb-6">Paid Expenses</h1>
        
        {transactions.length === 0 && <p class="bold text-xl"> No Paid Expense Transactions</p>}
